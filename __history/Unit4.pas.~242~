...
begin
  ...
  lblRevealAnswer.Caption := 'Correct answer: ' + rgpQuestion.Items[rgpQuestion.ItemIndex];
...
begin
  ...
  //lblQuestion.Caption := 'Question 1: What is the balanced form of this equation?' + #13 + 'H₂ + O₂ → H₂O';
  //rgpQuestion.Caption := 'Choose an Option below';
